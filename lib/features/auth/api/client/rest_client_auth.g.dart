...
class _RestClientAuth implements RestClientAuth {
  _RestClientAuth(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<HttpResponse<SignInResponseModel>> signIn(
    ...
    final _options = _setStreamType<HttpResponse<SignInResponseModel>>(
